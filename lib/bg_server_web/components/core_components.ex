defmodule BgServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BgServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BgServerWeb.Gettext, "errors", msg, opts)
    end
  end
